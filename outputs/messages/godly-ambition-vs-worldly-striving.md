...
- Identifying Characteristics (Derived from Cases):
    - Motivation: Self (glory, power, wealth, status, recognition). `[Write on board: Worldly Ambition -> SELF (Glory, Power, Status)]`
...
- Identifying Characteristics (Derived from Cases):
    - Motivation: God's glory, His will, love for Him & others, advancing His kingdom. `[Write on board: Godly Ambition -> GOD (Glory, Will, Service)]`
